...
#file_name = File.join(Rails.root, 'spec', 'webmocks', 'evernote_metadata.txt')
#File.open(file_name, 'w') { |f| f.puts note_metadata.inspect }
...
#file_name = File.join(Rails.root, 'spec', 'webmocks', 'evernote_note_tags.txt')
#File.open(file_name, 'w') { |f| f.puts tag_names.inspect }
...
#file_name = File.join(Rails.root, 'spec', 'webmocks', 'evernote_note_data.txt')
#File.open(file_name, 'w') { |f| f.puts note_data.inspect }
...
#file_name = File.join(Rails.root, 'spec', 'webmocks', 'evernote_resource_data.txt')
#File.open(file_name, 'w') { |f| f.puts cloud_resource_data.inspect }

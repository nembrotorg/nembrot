...
Commontator.configure do |config|
  ...
  config.user_name_proc = lambda { |user| user.public_name }
  ...
  # Default: true
  config.can_edit_own_comments = false # REVIEW: Temporarily disabled
  ...
  # Default: true
  config.can_delete_own_comments = false # REVIEW: Temporarily disabled

  # Whether users can delete their own comments
  # after someone posted a newer comment
  # Default: false
  config.can_delete_old_comments = false # REVIEW: Temporarily disabled

  # Whether users can manually subscribe or unsubscribe to threads
  # Default: true
  config.can_subscribe_to_thread = false # REVIEW: Temporarily disabled
  ...
  # Default: false
  config.can_vote_on_comments = false # REVIEW: Temporarily disabled
  ...
  # Default: true
  config.closed_threads_are_readable = false # REVIEW: Temporarily disabled

  # Whether to show that comments deleted by a moderator actually existed
  # (the content will be hidden either way)
  # Default: true
  config.deleted_comments_are_visible = false # REVIEW: Temporarily disabled
  ...
  config.subscription_email_from_proc = lambda { |params| Setting['advanced.contact_email'] }

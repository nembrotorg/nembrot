# RailsAdmin config file. Generated on July 30, 2012 00:05
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Nembrot', 'Admin']
  ...
  # config.excluded_models = [Note, NoteVersion]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Note, NoteVersion]

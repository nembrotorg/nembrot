...
note.tag_list = "food, taste, sensualist"
note.save
...
note.tag_list = "food, gourmand, taste"
note.save
cloud_note.note_id = note.id
cloud_note.save
...
note.tag_list = "food, gourmand, foie gras"
note.save
cloud_note.note_id = note.id
cloud_note.save
...
note.tag_list = "food, garlic, foie gras"
note.save
cloud_note.note_id = note.id
cloud_note.save
...
note.tag_list = "meat, chicken, foie gras"
note.save
cloud_note.note_id = note.id
cloud_note.save
...
note.tag_list = "chicken, liver, foie gras"
note.save
cloud_note.note_id = note.id
cloud_note.save

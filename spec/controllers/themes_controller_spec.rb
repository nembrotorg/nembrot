...
describe ThemesController do
  ...
  let(:valid_attributes) { { "premium" => "false" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved theme as @theme" do
        ...
        post :create, {:theme => { "premium" => "invalid value" }}, valid_session
        assigns(:theme).should be_a_new(Theme)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested theme" do
        ...
        Theme.any_instance.should_receive(:update).with({ "premium" => "false" })
        put :update, {:id => theme.to_param, :theme => { "premium" => "false" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the theme as @theme" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Theme.any_instance.stub(:save).and_return(false)
        put :update, {:id => theme.to_param, :theme => { "premium" => "invalid value" }}, valid_session
        assigns(:theme).should eq(theme)
      end

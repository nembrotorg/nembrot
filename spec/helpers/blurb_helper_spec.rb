...
describe BlurbHelper do
  ...
  describe '#blurb' do
    it 'returns a headline and a blurb' do
      blurb('Headline', nil, 'Body.').should ==  ['Headline: ', 'Body.']
    end

    context 'the body starts with the headline' do
      it 'omits the headline from the body' do
        blurb('Headline', nil, 'Headline is already in the body.').should ==  ['Headline', ' is already in the body.']
      end
    end
    ...
    context 'when an introduction is provided' do
      it 'uses the introduction for the blurb' do
        ...
        blurb('Headline', nil, 'Headline is already in the body.', 'It has a rather long introduction, actually!').should ==  ['Headline: ', 'It has a rather long introduction,...']
      end
    end

    context 'when the introduction is too short' do
      it 'does not use the introduction' do
        blurb('Headline', nil, 'Body.', 'Introduction!').should ==  ['Headline: ', 'Body.']
      end
    end
  end
